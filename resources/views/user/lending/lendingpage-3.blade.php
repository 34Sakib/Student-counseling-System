    ...
    <div class="row w-100 m-0 d-flex align-items-center onboarding-row">
        ...
        <div class="col-lg-7 d-flex flex-column justify-content-start align-items-start onboarding-content">
            ...
            <div class="mb-5 onboarding-heading-box">
                ...
                <div class="lp3-progress-wrap">
                    <div class="lp3-progress-bar-bg">
                        <div class="lp3-progress-bar-fill"></div>
                    </div>
                    <span class="lp3-step-badge">3</span>
                </div>
            </div>
            ...
            <div class="bg-white rounded-4 shadow-sm p-4 onboarding-question-box">
                <div class="d-flex align-items-center mb-4">
                    <a href="{{ route('lending.onboarding2') }}" class="onboarding-back-link">
                        &#8592;
                    </a>
                    <span class="fw-bold fs-5">Which subject areas are you interested in?</span>
                </div>

                <form action="{{ route('lending.onboarding4') }}" method="GET">
                    <div class="mb-4">
                        <select class="form-select select-input">
                            <option selected disabled>Enter course subject e.g. Law</option>
                            <option>Law</option>
