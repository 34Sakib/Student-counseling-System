...
<section class="accommodation-section py-4">
  <div class="accommodation-container">
    <div class="accommodation-header mb-1">
      <span class="accommodation-heading-main">Find</span><span class="accommodation-heading-main"> your home away from home</span>
      <div class="accommodation-underline"></div>
    </div>
    <div class="accommodation-desc mb-2">
      Accepted a university offer but unsure of your accommodation abroad? Don’t worry, IDP has it all covered. Choose from a variety of options, including student apartments or homestay. We take care of rental applications and contracts, so you have one less thing to worry about as you prepare for the big journey.
    </div>
    <div class="accommodation-feature-row">
      <div class="accommodation-feature-card">
        <div class="accommodation-feature-content">
          <img src="https://i.postimg.cc/NG288KFb/image.png" alt="icon" class="accommodation-feature-icon"> 
          <div>
            <div class="accommodation-feature-title">Trusted accommodation partners</div>
            <div class="accommodation-feature-desc">Across Australia, Canada, UK, and New Zealand</div>
          </div>
        </div>
      </div>
      <div class="accommodation-feature-card">
        <div class="accommodation-feature-content">
          <img src="https://i.postimg.cc/NG288KFb/image.png" alt="icon" class="accommodation-feature-icon"> 
          <div>
            <div class="accommodation-feature-title">Exclusive deals</div>
            <div class="accommodation-feature-desc">has access to exclusive rates and deals.</div>
          </div>
        </div>
      </div>
      <div class="accommodation-feature-card">
        <div class="accommodation-feature-content">
          <img src="https://i.postimg.cc/NG288KFb/image.png" alt="icon" class="accommodation-feature-icon"> 
          <div>
            <div class="accommodation-feature-title">Comparison tool</div>
            <div class="accommodation-feature-desc">Compare accommodation to make the right choice with our comparison tool</div>
          </div>
        </div>
      </div>
      <div class="accommodation-feature-card">
        <div class="accommodation-feature-content">
          <img src="https://i.postimg.cc/NG288KFb/image.png" alt="icon" class="accommodation-feature-icon"> 
          <div>
            <div class="accommodation-feature-title">Counsellor support</div>
            <div class="accommodation-feature-desc">Across Australia, Canada, UK, and New Zealand</div>
          </div>
        </div>
      </div>
...
<!-- Student Apartments Section -->
<section class="student-apartments-section py-5">
  <div class="student-apartments-fullwidth">
    <div class="student-apartments-container d-flex flex-column flex-md-row align-items-center justify-content-between">
      <div class="student-apartments-img-col mb-4 mb-md-0">
        <img src="https://i.postimg.cc/D0q317R6/image.png" alt="Student Apartments" class="student-apartments-img rounded-3 w-100">
      </div>
      <div class="student-apartments-info-col ms-md-5">
        <h2 class="student-apartments-title mb-2">Student Apartments</h2>
        <div class="student-apartments-underline mb-3"></div>
        <div class="student-apartments-intro mb-3">Student apartments are a fantastic choice if you are looking for convenience, affordability, and the chance to share your experience with students from all over the world. Everything you need is in one place and you can move in straight away.</div>
        <div>
          <div class="student-apartments-why-title fw-bold mb-2">Why choose a student Apartment?</div>
          <ul class="student-apartments-list ps-3">
            <li>It’s easy to make friends and socialize.</li>
            <li>Support staff are available if need help or are unsure about anything.</li>
            <li>Apartments are usually close to campus, so you spend less time traveling</li>
            <li>You live in a safe, secure environment</li>
          </ul>
        </div>
      </div>
    </div>
